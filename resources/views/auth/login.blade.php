...
<div class="d-flex align-items-center justify-content-center bg-br-primary ht-100v">
        ...
        <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base">
          <div class="signin-logo tx-center tx-28 tx-bold tx-inverse"><span class="tx-normal">[</span> In-Mail <span class="tx-normal">]</span></div>
          ...
          <div class="mg-t-60 tx-center">Para más información visite: <a href="" class="tx-info">Index S.A.S</a></div>
        </div><!-- login-wrapper -->
      </div>
